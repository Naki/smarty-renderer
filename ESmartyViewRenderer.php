...
class ESmartyViewRenderer extends CApplicationComponent implements IViewRenderer
{
    ...
    */
    ...
    /**
    * Enable or disable trim whitespaces output filter.
    *
    * @var mixed
    * @since 1.0.8
    */
    public $enableTrimWhiteSpacesFilter = false;
    ...
    */
    public function getSmarty()
    {
        if ($this->_smarty === null) {
            ...
            if ($this->enableTrimWhiteSpacesFilter) {
    ...
    public function init()
    {
        ...
        if (!defined('SMARTY_SPL_AUTOLOAD')) {
            ...
            throw new CException(
                'ESmartyViewRenderer cannot work with SMARTY_SPL_AUTOLOAD enabled. Set SMARTY_SPL_AUTOLOAD to 0.'
            );
        }
        ...
        $this->getSmarty()->default_template_handler_func = create_function(
            '$type, $name',
    ...
    */
    public function renderFile($context, $sourceFile, $data, $return)
    {
        ...
        if (!is_file($sourceFile) || ($file = realpath($sourceFile)) === false) {
            throw new CException(
                Yii::t('yiiext', 'View file "{file}" does not exist.', ['{file}' => $sourceFile])
            );
        }
